...
namespace FormElement
{
    public partial class Form1 : Form
    {
        ...
        void listBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            {
                case ("Красный"): tree.BackColor = Color.Red; break;
                case ("Желтый"): tree.BackColor = Color.Yellow; break;
                case ("Синий"): tree.BackColor = Color.Blue; break;
                case ("Серый"): tree.BackColor = Color.Gray; break;
                case ("Фиолетовый"): tree.BackColor = Color.Violet; break;
            }
        }
